  ...
  jsxReadToken() {
    ...
    for (;;) {
      ...
      switch (ch) {
        case 60:
        case 123:
          if (this.input.charCodeAt(this.state.pos + 1) === 123 && this.input.charCodeAt(this.state.pos - 1) !== 61) ++this.state.pos;
        ...
        case 62:
        case 125:
          if (this.input.charCodeAt(this.state.pos + 1) === 125 && this.input.charCodeAt(this.state.pos - 1) !== 61) ++this.state.pos;
